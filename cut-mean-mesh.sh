...
~/src/julia-0.4/julia mesh-cut-plane.jl  0.0  -0.2   -1.0  48.0  false mm-solid-cut1.off mm-solid-cut2.off
~/src/julia-0.4/julia mesh-cut-plane.jl  0.0  -0.2    1.0  14.0  false mm-solid-cut2.off mm-solid-cut3.off
~/src/julia-0.4/julia mesh-cut-plane.jl -1.0  -0.001  0.0  28.1  true  mm-solid-cut3.off mm-solid-cut4.off
~/src/julia-0.4/julia mesh-cut-plane.jl  1.0  -0.001  0.0  28.1  true  mm-solid-cut4.off mm-solid-cut5.off
~/src/julia-0.4/julia mesh-cut-plane-extend.jl  0.0   0.15   1.0  35.0  false -80.0 mm-solid-cut5.off mm-solid-cut.off mm-solid-ext.off
...
meshlabserver -i mm-solid-ext.off -o $3 -s remove-dup.xml
rm mm-solid-cut.off
rm mm-solid-ext.off